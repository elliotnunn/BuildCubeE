...
OSErr ResolveFolderAliases (
	/* Info in  */	short volume, long directory, Str255 path, Boolean resolveLeafAlias,
	/* Info out */	FSSpec *theSpec, Boolean *isFolder, Boolean *hadAlias, Boolean *leafIsAlias);
OSErr MakeResolvedFSSpec (short volume, long directory, Str255 path,
...
OSErr MakeResolvedPath (short volume, long directory, Str255 path, Boolean resolveLeafAlias,
